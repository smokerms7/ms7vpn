...
const (
	...
	windowHeight = 720
	minWidth     = 900
	// Минимальная высота подобрана по содержимому главного экрана: при 640
	// последняя строка упиралась в край окна впритык, и хватило бы любой
	// мелочи в метриках шрифта, чтобы её обрезало.
	minHeight = 668
)
